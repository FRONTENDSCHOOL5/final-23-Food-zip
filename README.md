...
|<pre><div>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</div>- 게시글 리스트형, 앨범형<div>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</div></pre>|<pre><div>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</div>- 현재 프로필 정보를 유지한 상태로 수정 페이지 이동<br>- accountname 유효성 검사<br>- validation을 통과해야 수정 가능<div>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</div></pre>|
...
|<pre><div>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</div>- 추천맛집 등록, 수정, 삭제 기능<div>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</div></pre>|<pre><div>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</div>- 카카오맵 API를 이용하여 추천 맛집 위치 확인 가능<div>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</div></pre>|
...
```
## 추후 리팩토링 계획
본 프로젝트의 리팩토링 계획은 다음과 같습니다:
1. 코드 구조 개선: API와 Custom Hook 및 Recoil을 도입해 가독성과 재사용성을 높입니다.
2. 시맨틱 태그 사용 및 접근성 향상: 시맨틱 태그를 사용하고 접근성을 향상 시킵니다.
3. 버그 수정: 테스트 과정에서 발견된 버그들을 수정하고, 수정된 코드를 다시 테스트하여 안정성을 확보합니다.
4. 주석 및 문서화: 전체 코드에 주석을 추가하고, wiki나 기술 문서를 작성하여 프로젝트의 구조와 기능의 이해도를 높입니다.
5. 성능 최적화: 코드 실행 속도 및 메모리 사용량을 최소화하는 방법을 찾고, 최적화된 코드로 변경합니다.
   - 현재 Light House 점수는 성능 기준으로 /home = 85, /myprofile = 77 /detailpost 및 상대 프로필 검사 불가 /그 외 페이지 99점  
리팩토링을 진행함에 있어 모든 팀원의 참여와 의견 수렴을 통해 프로젝트의 효율성을 극대화할 계획입니다. 더 나은 결과물을 만들기 위해 지속적인 코드 개선을 추진할 예정입니다.
